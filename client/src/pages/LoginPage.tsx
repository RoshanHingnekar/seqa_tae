        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-500 mt-1">
              Sign in to manage projects and calculate QA testing resource estimates.
            </p>
          </div>
            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="text-[11px] text-slate-600 mt-0.5">
                  Pre-configured with demo project (152 person-hours) & Ramesh Kumar profile.
                </p>
              </div>
              <button
                type="button"
                ...
                className="shrink-0 px-3.5 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-xs shadow-xs transition-colors"
              >
                {demoLoading ? 'Signing in...' : '1-Click Login'}
              </button>
            </div>
          </div>

          {error && (
            <div className="p-3.5 rounded-xl bg-red-50 border border-red-200 text-red-700 text-xs font-medium animate-in fade-in duration-150">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="ramesh@qaestimator.io"
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <a href="#forgot" onClick={(e) => { e.preventDefault(); alert('Demo reset link sent to registered email.'); }} className="text-xs font-semibold text-blue-600 hover:text-blue-700">
                  Forgot Password?
                </a>
              </div>
              <div className="relative">
          ...
          <div className="relative flex items-center justify-center">
            ...
            <span className="bg-[#F8FAFC] px-3 text-[11px] text-slate-400 font-medium uppercase tracking-wider">
              Or continue with
            </span>
          </div>
          ...
          <button
            type="button"
            onClick={handleDemoLogin}
            className="w-full py-2.5 px-4 rounded-xl bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-semibold text-xs shadow-xs transition-colors flex items-center justify-center gap-2.5"
          >
